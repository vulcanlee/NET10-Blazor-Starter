...
namespace MyProject.AccessDatas.Migrations
{
    ...
    [Migration("20260917011729_AddTokenUsageCost")]
    partial class AddTokenUsageCost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.ExceptionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("StackTraceFile")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.RolePermissionMap", b =>
                {
                    ...
                    b.HasIndex("RoleViewId", "PermissionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.TokenUsageLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<double?>("CostExchangeRate")
                        .HasColumnType("REAL");

                    b.Property<bool>("CostLongContext")
                        .HasColumnType("INTEGER");

                    b.Property<string>("CostPriceKey")
                        .HasColumnType("TEXT");

                    b.Property<string>("CostRateSnapshot")
                        .HasColumnType("TEXT");

                    b.Property<double?>("CostTwd")
                        .HasColumnType("REAL");
                    ...
                    b.Property<int?>("ImageCachedInputCount")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("ImageInputCount")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("ImageOutputCount")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("RawUsageFile")
                        .HasColumnType("TEXT");

                    b.Property<int?>("ReasoningCount")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.UserRole", b =>
                {
                    ...
                    b.HasIndex("MyUserId", "RoleViewId")
                        .IsUnique();

                    b.ToTable("UserRole");
                });

            modelBuilder.Entity("MyProject.AccessDatas.Models.UserTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.RolePermissionMap", b =>
                {
                    b.HasOne("MyProject.AccessDatas.Models.Permission", "Permission")
                        .WithMany()
            ...
            modelBuilder.Entity("MyProject.AccessDatas.Models.UserTeam", b =>
                {
                    ...
                    b.HasOne("MyProject.AccessDatas.Models.Team", "Team")
                        .WithMany()
